...
const PlaceListPage = () => {
  ...
  const onSearchTextChange = (e: ChangeEvent<HTMLInputElement>) => {
    ...
    if (text && text.length > 0) {
      ...
      if (text.startsWith("#")) {
        ...
        list = originList.filter((place) => place.name.includes(text) || text.includes(place.name));
              ...
              dropdown={
                <Menu.Dropdown header={<Menu.Header>{TEXT.MSG_SORTING_MENU}</Menu.Header>}>
                  ...
                  <Menu.DropdownCheckItem
                    ...
                    onCheckedChange={(checked: boolean) =>
                      onSortMenuChange(MENU_SORT_NAME_DESC, TEXT.MENU_SORT_NAME_DESC)
                    }
                  >
                  ...
                  <Menu.DropdownCheckItem
                    ...
                    onCheckedChange={(checked: boolean) =>
                      onSortMenuChange(MENU_SORT_NAME_ASC, TEXT.MENU_SORT_NAME_ASC)
                    }
                  >
                  ...
                  <Menu.DropdownCheckItem
                    ...
                    onCheckedChange={(checked: boolean) =>
                      onSortMenuChange(MENU_SORT_RECENT_RATING_DESC, TEXT.MENU_SORT_RECENT_RATING_DESC)
                    }
                  >
                  ...
                  <Menu.DropdownCheckItem
                    ...
                    onCheckedChange={(checked: boolean) =>
                      onSortMenuChange(MENU_SORT_RECENT_RATING_ASC, TEXT.MENU_SORT_RECENT_RATING_ASC)
                    }
                  >
                  ...
                  <Menu.DropdownCheckItem
                    ...
                    onCheckedChange={(checked: boolean) =>
                      onSortMenuChange(MENU_SORT_RECENT_VISIT_DESC, TEXT.MENU_SORT_RECENT_VISIT_DESC)
                    }
                  >
                  ...
                  <Menu.DropdownCheckItem
                    ...
                    onCheckedChange={(checked: boolean) =>
                      onSortMenuChange(MENU_SORT_RECENT_VISIT_ASC, TEXT.MENU_SORT_RECENT_VISIT_ASC)
                    }
                  >
                  ...
                  <Menu.DropdownCheckItem
                    ...
                    onCheckedChange={(checked: boolean) =>
                      onSortMenuChange(MENU_SORT_RECENT_VISIT_COUNT_DESC, TEXT.MENU_SORT_RECENT_VISIT_COUNT_DESC)
                    }
                  >
                  ...
                  <Menu.DropdownCheckItem
                    ...
                    onCheckedChange={(checked: boolean) =>
                      onSortMenuChange(MENU_SORT_RECENT_VISIT_COUNT_ASC, TEXT.MENU_SORT_RECENT_VISIT_COUNT_ASC)
                    }
                  >
                  ...
                  <ListHeader
                    ...
                    right={
                      <ListRightWrapper>
                        ...
                        <Rating
                          readOnly={true}
                          value={placeHistory.rating}
                          max={placeHistory.rating}
                          size="medium"
                          variant="iconOnly"
                      ...
                      <>
                        ...
                        <ListDescriptionWrapper>
                          ...
                          <Text style={{ fontStyle: "italic", fontSize: 14, marginTop: 5 }}>
                            {Array.from(placeHistory.tags)}
                          </Text>
                          <Text style={{ fontSize: 14, marginTop: 5, alignSelf: "flex-end" }}>
                            {TEXT.VISIT_AT} {placeHistory.visitAt}
                          </Text>
                        </ListDescriptionWrapper>
                      </>
                    }
  ...
  const listView = () => {
    return (
      <ListWrapper>
        {categoryMap &&
          sortedFilteredList.map((place: Place) => {
                ...
                <ListHeader
                  ...
                  right={
                    <ListRightWrapper>
                      ...
                      {recentHistory && (
                        <Rating
                          readOnly={true}
                          value={recentHistory.rating}
                          max={recentHistory.rating}
                          size="medium"
                          variant="iconOnly"
                          aria-label={TEXT.RATING}
                        />
                  ...
                  description={
                    <>
                      ...
                      <ListDescriptionWrapper>
                        {recentHistory && (
                          <ListHeader.DescriptionParagraph>{recentHistory.memo}</ListHeader.DescriptionParagraph>
                        )}
                        {recentHistory && (
                        ...
                        {recentHistory && (
                          <Text style={{ fontSize: 14, marginTop: 5, alignSelf: "flex-end" }}>
                            {TEXT.RECENT_VISIT_AT} {recentHistory.visitAt}
                          </Text>
                        )}
                        <Text style={{ fontSize: 14, marginTop: 5, alignSelf: "flex-end" }}>
                          총 {place.historyList.length}회 방문
                        </Text>
                      </ListDescriptionWrapper>
                    </>
                  }
    ...
    return (
      <>
        <Result
          ...
          title={TEXT.MSG_EMPTY_LIST}
          description={TEXT.MSG_EMPTY_LIST_DESC}
        />
      </>
    );
  };
  ...
  return (
    <div style={{ paddingLeft: 10, paddingRight: 10 }}>
      ...
      {originList.length === 0 ? (
        ...
        <>{sortedFilteredList.length === 0 && filteredHistoryList.length === 0 && emptyResultView()}</>
      )}
